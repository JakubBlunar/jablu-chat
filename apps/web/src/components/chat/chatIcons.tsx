...
/** System share sheet / copy link fallback */
export function ShareIcon({ className = 'h-4 w-4', strokeWidth = 2, ...rest }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth} {...rest}>
...
export function ForwardIcon({ className = 'h-4 w-4', strokeWidth = 2, ...rest }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth} {...rest}>
...
export function MembersIcon({ className = 'h-5 w-5', strokeWidth = 2, ...rest }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" aria-hidden={true} {...rest}>
