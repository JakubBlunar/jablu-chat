  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-gray-400 leading-relaxed">
        Install Jablu as an app on your device for quick access, push
        notifications, and a full-screen experience — no app store needed.
      </p>
    ...
    <div className="space-y-3 border-t border-white/10 pt-5">
      ...
      <div className="space-y-4">
        {others.map((guide) => (
          <details
            key={guide.label}
            className="group rounded-lg bg-surface-darkest"
          >
...
function FirefoxDesktopGuide() {
  return (
    <div className="text-sm text-gray-400 leading-relaxed">
      <p>
        Firefox desktop does not currently support installing PWAs directly.
        For the best app experience on desktop, try opening Jablu in{" "}
        <strong className="text-gray-300">Chrome</strong> or{" "}
        <strong className="text-gray-300">Edge</strong> and installing from
        there.
      </p>
    </div>
  );
  ...
  return (
    <div className="text-sm text-gray-400 leading-relaxed">
      <p>
        ...
        <strong className="text-gray-300">"Install app"</strong> option in your
        browser&rsquo;s menu. If your browser doesn&rsquo;t support
        installation, try opening Jablu in Chrome, Edge, or Safari.
      </p>
    </div>
  );
}
