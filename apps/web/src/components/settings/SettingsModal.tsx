        ...
        <div className="rounded-lg bg-surface-dark p-4">
          ...
          {permStatus === "denied" && (
            <p className="mt-1 text-xs text-gray-500">
              You have blocked notifications for this site. Update your browser
          ...
          <ul className="mt-2 space-y-1.5 text-xs text-gray-400">
            {isBrave && (
              <li>
                ...
                and enable <strong className="text-gray-300">"Use Google services for push messaging"</strong>.
                This is required for push notifications to work.
              </li>
            )}
            <li>
              Make sure notifications are allowed in your operating system settings for this browser.
            </li>
            <li>
              If you are using a VPN or firewall, ensure it does not block push service connections.
            </li>
            <li>
              Try closing all tabs and reopening the app, then click "Enable Push Notifications" again.
            </li>
          </ul>
        </div>
      )}
...
function ActiveSessionsSection() {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-400">
        Devices where your account is currently logged in. Revoke sessions you
        don't recognize.
      </p>
      ...
      <div className="space-y-2">
        {sessions.map((s, i) => (
          <div
            key={s.id}
            className="flex items-center gap-3 rounded-lg bg-surface-dark px-4 py-3"
          >
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-gray-400">
                ...
                {formatSessionDate(s.lastUsedAt)}
              </p>
            </div>
            {i !== 0 && (
              <button
