...
type Tab = 'servers' | 'users' | 'invites' | 'audit' | 'stats' | 'moderation' | 'webhooks' | 'storage' | 'push' | 'deleted'
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-4 flex gap-1 border-b border-white/10">
          {(
            ...
            else if (t === 'deleted') label = 'Deleted Messages'
            return (
              <button
                key={t}
                type="button"
