...
var Gi = [0, yi, Ri, Ei, -1, _i, Ri, -1],
  ...
  Vi = [
    ...
    ti(
      function (t, e, n) {
        return (0 === t.h || 2 === t.h) && ((e = Je(e, tt(e), n, 2, !1)), 2 == t.h ? Zn(t, jn, e) : e.push(Un(t.g)), !0)
      },
      function (t, e, n) {
        if (null != (e = Zr(Yt, e)) && e.length) {
          n = mr(t, n)
    ...
    ;(qi(n, 'mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph'),
      ...
      this.outputFaceBlendshapes &&
        ...
        this.g.attachProtoVectorListener('blendshapes', (t, e) => {
          if (this.outputFaceBlendshapes) for (const e of t) ((t = fs(e)), this.j.faceBlendshapes.push(Po(t.g() ?? [])))
          ea(this, e)
        }),
  ...
  m() {
    ...
    ;(qi(n, 'mediapipe.tasks.vision.image_classifier.ImageClassifierGraph'),
      ...
      this.g.attachProtoListener('classifications', (t, e) => {
        ;((this.j = (function (t) {
          const e = { classifications: mn(t, As, 1).map((t) => Po(pn(t, us, 4)?.g() ?? [], Tn(bn(t, 2), 0), kn(t, 3))) }
...
var $c = class extends ic {
  ...
  fa(t, e, n, r) {
    ...
    if (e.keypoint) {
      ...
      for (a of ((o = new Wc()), e.scribble)) (Sn((e = new Xc()), 3, !0), Ln(e, 1, a.x), Ln(e, 2, a.y), wn(o, 1, Xc, e))
      _n(s, 15, Kc, o)
    }
